...
<input title="{$APP.LBL_CANCEL_BUTTON_TITLE}" class="button" onclick="return SUGAR.subpanelUtils.cancelCreate($(this).attr('id'));return false;" type="submit" name="AOS_Product_Categories_subpanel_cancel_button" id="AOS_Product_Categories_subpanel_cancel_button" value="{$APP.LBL_CANCEL_BUTTON_LABEL}"> 
