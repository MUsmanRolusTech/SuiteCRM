<?php /* Smarty version 2.6.33, created on 2022-04-26 10:47:55
         compiled from modules/AM_ProjectTemplates/tpls/ListViewGeneric.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'modules/AM_ProjectTemplates/tpls/ListViewGeneric.tpl', 42, false),array('function', 'sugar_include', 'modules/AM_ProjectTemplates/tpls/ListViewGeneric.tpl', 81, false),array('function', 'counter', 'modules/AM_ProjectTemplates/tpls/ListViewGeneric.tpl', 133, false),array('function', 'sugar_translate', 'modules/AM_ProjectTemplates/tpls/ListViewGeneric.tpl', 155, false),array('function', 'sugar_getimage', 'modules/AM_ProjectTemplates/tpls/ListViewGeneric.tpl', 161, false),array('function', 'sugar_ajax_url', 'modules/AM_ProjectTemplates/tpls/ListViewGeneric.tpl', 231, false),array('function', 'sugar_evalcolumn_old', 'modules/AM_ProjectTemplates/tpls/ListViewGeneric.tpl', 235, false),array('function', 'sugar_field', 'modules/AM_ProjectTemplates/tpls/ListViewGeneric.tpl', 237, false),array('modifier', 'replace', 'modules/AM_ProjectTemplates/tpls/ListViewGeneric.tpl', 85, false),array('modifier', 'default', 'modules/AM_ProjectTemplates/tpls/ListViewGeneric.tpl', 141, false),array('modifier', 'lower', 'modules/AM_ProjectTemplates/tpls/ListViewGeneric.tpl', 144, false),array('modifier', 'upper', 'modules/AM_ProjectTemplates/tpls/ListViewGeneric.tpl', 148, false),)), $this); ?>
    ...
    <div class="list view listViewEmpty">
        <?php if ($this->_tpl_vars['displayEmptyDataMesssages']): ?>
            <?php if (strlen ( $this->_tpl_vars['query'] ) == 0): ?>
                <?php ob_start(); ?><a
                    href="index.php?module=<?php echo $this->_tpl_vars['pageData']['bean']['moduleDir']; ?>
...
&return_action=DetailView"><?php echo $this->_tpl_vars['APP']['LBL_CREATE_BUTTON_LABEL']; ?>
                ...
                <?php ob_start(); ?><a
                    href="index.php?module=Import&action=Step1&import_module=<?php echo $this->_tpl_vars['pageData']['bean']['moduleDir']; ?>
...
&return_action=index"><?php echo $this->_tpl_vars['APP']['LBL_IMPORT']; ?>
                ...
                <?php ob_start(); ?><a target="_blank"
                                              href='index.php?module=Administration&action=SupportPortal&view=documentation&version=<?php echo $this->_tpl_vars['sugar_info']['sugar_version']; ?>
...
&help_action=&key='><?php echo $this->_tpl_vars['APP']['LBL_CLICK_HERE']; ?>
                ...
                <div class="filterContainer">
                    <?php if ($this->_tpl_vars['showFilterIcon']): ?>
                        <?php echo smarty_function_sugar_include(array('type' => 'smarty','file' => 'include/ListView/ListViewSearchLink.tpl'), $this);?>
...
"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('quotedQuery', ob_get_contents());ob_end_clean(); ?>
                ...
                <p class="submsg">
                    <a href="index.php?module=<?php echo $this->_tpl_vars['pageData']['bean']['moduleDir']; ?>
&action=EditView&return_module=<?php echo $this->_tpl_vars['pageData']['bean']['moduleDir']; ?>
&return_action=DetailView">
                    ...
                    <?php echo $this->_tpl_vars['APP']['MSG_LIST_VIEW_CHANGE_SEARCH']; ?>
...
<?php if ($this->_tpl_vars['hideTable'] == false): ?>
    <table cellpadding='0' cellspacing='0' width='100%' border='0' class='list view table'>
        ...
        <?php echo smarty_function_sugar_include(array('type' => 'smarty','file' => 'include/ListView/ListViewPagination.tpl'), $this);?>
...
?>
            ...
            <?php endif; ?>
            <tr class='<?php echo $this->_tpl_vars['_rowColor']; ?>
S1'>
                <?php if ($this->_tpl_vars['prerow']): ?>
