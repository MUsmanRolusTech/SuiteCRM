<?php /* Smarty version 2.6.33, created on 2022-04-26 10:50:51
...
>
						...
						<tr>
							<td width="20%" scope="row" valign='top'>
								<?php echo $this->_tpl_vars['MOD']['LBL_EMAIL_WARNING_NOTIFICATIONS']; ?>
:&nbsp;
							</td>
							<td width="30%"  valign='top'>
								<input type='checkbox' class='checkbox' name='email_warning_notifications' value="1" <?php echo $this->_tpl_vars['LBL_EMAIL_WARNING_NOTIFICATIONS']; ?>
>
							</td>
						</tr>
						<tr>
...
:&nbsp;
							...
							<td width="30%"  valign='top'>
								<input type='checkbox' class='checkbox' name='email_default_delete_attachments' value="1" <?php echo $this->_tpl_vars['DEFAULT_EMAIL_DELETE_ATTACHMENTS']; ?>
>
							</td>
