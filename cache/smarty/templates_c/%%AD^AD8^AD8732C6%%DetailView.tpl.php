<?php /* Smarty version 2.6.33, created on 2022-04-26 10:53:25
         compiled from cache/themes/SuiteP/modules/AOK_Knowledge_Base_Categories/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/AOK_Knowledge_Base_Categories/DetailView.tpl', 40, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/AOK_Knowledge_Base_Categories/DetailView.tpl', 49, false),array('function', 'counter', 'cache/themes/SuiteP/modules/AOK_Knowledge_Base_Categories/DetailView.tpl', 107, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/AOK_Knowledge_Base_Categories/DetailView.tpl', 100, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/AOK_Knowledge_Base_Categories/DetailView.tpl', 154, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/AOK_Knowledge_Base_Categories/DetailView.tpl', 154, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/AOK_Knowledge_Base_Categories/DetailView.tpl', 154, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='AOK_Knowledge_Base_Categories'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='AOK_Knowledge_Base_Categories'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='AOK_Knowledge_Base_Categories'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='AOK_Knowledge_Base_Categories'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
