<?php /* Smarty version 2.6.33, created on 2022-04-26 11:17:03
         compiled from cache/themes/SuiteP/modules/FP_Event_Locations/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/FP_Event_Locations/DetailView.tpl', 40, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/FP_Event_Locations/DetailView.tpl', 49, false),array('function', 'counter', 'cache/themes/SuiteP/modules/FP_Event_Locations/DetailView.tpl', 108, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/FP_Event_Locations/DetailView.tpl', 101, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/FP_Event_Locations/DetailView.tpl', 186, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/FP_Event_Locations/DetailView.tpl', 186, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/FP_Event_Locations/DetailView.tpl', 186, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='FP_Event_Locations'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='FP_Event_Locations'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='FP_Event_Locations'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='FP_Event_Locations'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="capacity">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="varchar" field="capacity" >

<?php if (! $this->_tpl_vars['fields']['capacity']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['capacity']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['capacity']['value']; ?>
</span>
<?php endif; ?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="address">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="varchar" field="address" >

<?php if (! $this->_tpl_vars['fields']['address']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['address']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['address']['value']; ?>
</span>
<?php endif; ?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="address_country">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="varchar" field="address_country" >
