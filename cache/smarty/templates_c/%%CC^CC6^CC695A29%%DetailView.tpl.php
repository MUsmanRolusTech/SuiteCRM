<?php /* Smarty version 2.6.33, created on 2022-04-26 10:49:13
         compiled from cache/themes/SuiteP/modules/Surveys/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Surveys/DetailView.tpl', 41, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Surveys/DetailView.tpl', 50, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Surveys/DetailView.tpl', 109, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Surveys/DetailView.tpl', 102, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/Surveys/DetailView.tpl', 259, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/Surveys/DetailView.tpl', 259, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/Surveys/DetailView.tpl', 259, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Surveys'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Surveys'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Surveys'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Surveys'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<input type="submit" class="button" onClick="var _form = document.getElementById('formDetailView');_form.action.value='reports';SUGAR.ajaxUI.submitForm(_form);" value="<?php echo $this->_tpl_vars['MOD']['LBL_VIEW_SURVEY_REPORTS']; ?>
"/>
...
<li><input type="submit" class="button" onClick="var _form = document.getElementById('formDetailView');_form.action.value='reports';SUGAR.ajaxUI.submitForm(_form);" value="<?php echo $this->_tpl_vars['MOD']['LBL_VIEW_SURVEY_REPORTS']; ?>
"/></li>
...
<div class="col-xs-12 col-sm-12 detail-view-row-item" data-field="survey_url_display">


<div class="col-xs-12 col-sm-2 label col-1-label">


<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SURVEY_URL_DISPLAY','module' => 'Surveys'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<div class="col-xs-12 col-sm-10 detail-view-field" type="function" field="survey_url_display" colspan='3'>

<?php if (! $this->_tpl_vars['fields']['survey_url_display']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>

<span id='survey_url_display_span'>
<?php echo $this->_tpl_vars['fields']['survey_url_display']['value']; ?>
...
<div class="col-xs-12 col-sm-12 detail-view-row-item" data-field="survey_questions_display">
...
<div class="col-xs-12 col-sm-10 detail-view-field" type="function" field="survey_questions_display" colspan='3'>

<?php if (! $this->_tpl_vars['fields']['survey_questions_display']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
