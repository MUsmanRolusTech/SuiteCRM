<?php /* Smarty version 2.6.33, created on 2022-04-26 11:31:29
         compiled from modules/Import/tpls/step2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_help', 'modules/Import/tpls/step2.tpl', 76, false),array('modifier', 'upper', 'modules/Import/tpls/step2.tpl', 113, false),)), $this); ?>
<?php echo '
...
<td>
 ...
 &nbsp;<?php echo smarty_function_sugar_help(array('text' => $this->_tpl_vars['MOD']['LBL_SAMPLE_URL_HELP']), $this);?>
        ...
        <tr>
            <td align="left" scope="row" colspan="3"><div><label for="userfile"><?php echo $this->_tpl_vars['MOD']['LBL_SELECT_FILE']; ?>
</label></div> <div><input type="hidden" /><input size="20" id="userfile" name="userfile" type="file"/><?php echo smarty_function_sugar_help(array('text' => $this->_tpl_vars['MOD']['LBL_FILE_UPLOAD_WIDGET_HELP']), $this);?>
</div> <div><span class="small"><?php echo $this->_tpl_vars['APP']['LBL_LOGGER_VALID_FILENAME_CHARACTERS']; ?>
</span></div></td>
        </tr>
        <tr>
...
&nbsp;</h3></td>
    ...
    <br>
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
          <?php $_from = $this->_tpl_vars['custom_mappings']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }$this->_foreach['custommappings'] = array('total' => count($_from), 'iteration' => 0);
...
">
          ...
          <?php endif; ?>
          <?php $_from = $this->_tpl_vars['custom_imports']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }$this->_foreach['saved'] = array('total' => count($_from), 'iteration' => 0);
...
', '<?php echo $this->_tpl_vars['IMPORT_MODULE']; ?>
');">
                <?php endif; ?>
...
">
          ...
          <?php $_from = $this->_tpl_vars['published_imports']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }$this->_foreach['published'] = array('total' => count($_from), 'iteration' => 0);
